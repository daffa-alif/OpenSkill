  ...
  <nav class="nav-blur fixed top-0 left-0 right-0 z-50 px-6 py-4">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        <button class="btn-ghost text-sm px-4 py-2 rounded-lg text-gray-300 font-body">Masuk</button>
        <button class="btn-primary text-sm px-5 py-2 rounded-lg text-white font-semibold font-body">Daftar Gratis</button>
      </div>
    </div>
  </nav>
