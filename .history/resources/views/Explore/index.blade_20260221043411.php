...
<section class="px-6 pb-16">
  <div class="max-w-7xl mx-auto">
    <div class="flex items-center gap-3 mb-5">
      ...
      <a href="{{ route('webinar.index') }}" class="ml-auto font-body text-xs text-gray-600 hover:text-amber-vivid transition-colors flex items-center gap-1" style="color:rgba(255,255,255,0.35);">
