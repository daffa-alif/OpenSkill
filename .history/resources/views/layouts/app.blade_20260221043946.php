...
<body class="min-h-screen">
  ...
  <nav class="nav-blur fixed top-[33px] left-0 right-0 z-50 px-6 py-4">
    ...
    <div id="mobile-menu" class="mobile-menu md:hidden flex-col gap-1 pt-3 mt-3 border-t"
      ...
      <a href="{{ route('webinar') }}" class="nav-link {{ request()->routeIs('webinar.*') ? 'active' : '' }} px-2 py-2.5 block">Webinar</a>
      <a href="{{ route('seminar') }}" class="nav-link {{ request()->routeIs('seminar.*') ? 'active' : '' }} px-2 py-2.5 block">Seminar</a>
    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid sm:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <div class="space-y-2">
            <a href="{{ route('explore') }}" class="font-body text-xs text-gray-600 hover:text-gray-400 transition-colors block">Eksplorasi</a>
            <a href="{{ route('webinar') }}" class="font-body text-xs text-gray-600 hover:text-gray-400 transition-colors block">Webinar</a>
            <a href="{{ route('seminar') }}" class="font-body text-xs text-gray-600 hover:text-gray-400 transition-colors block">Seminar</a>
