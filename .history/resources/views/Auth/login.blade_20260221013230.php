...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .stagger-1 { animation: fadeUp 0.6s 0.08s ease forwards; opacity: 0; }
    .stagger-2 { animation: fadeUp 0.6s 0.18s ease forwards; opacity: 0; }
    .stagger-3 { animation: fadeUp 0.6s 0.28s ease forwards; opacity: 0; }
    .stagger-4 { animation: fadeUp 0.6s 0.38s ease forwards; opacity: 0; }
    .stagger-5 { animation: fadeUp 0.6s 0.48s ease forwards; opacity: 0; }
  ...
  <div class="relative z-10 min-h-screen flex">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-24">
      <div class="w-full max-w-md">
        ...
        <!-- Error alert -->
        @if ($errors->any())
          <div class="card-glass rounded-xl p-4 mb-6 flex items-start gap-3 stagger-1" style="border:1px solid rgba(239,68,68,0.25);">
        ...
        <!-- Divider -->
        <div class="flex items-center gap-4 my-8 stagger-5">
        ...
        <!-- Social -->
        <div class="grid grid-cols-2 gap-3 stagger-5">
