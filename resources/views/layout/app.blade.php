  ...
  <nav class="nav-blur fixed top-[33px] left-0 right-0 z-50 px-6 py-4">
    <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
      ...
      <div class="hidden md:flex items-center gap-7 font-body">
        <a href="{{ route('explore.index') }}"   class="nav-link {{ request()->routeIs('explore.*')  ? 'active' : '' }}">Eksplorasi</a>
        <a href="{{ route('webinar.index') }}"   class="nav-link {{ request()->routeIs('webinar.*')  ? 'active' : '' }}">Webinar</a>
        <a href="{{ route('seminar.index') }}"   class="nav-link {{ request()->routeIs('seminar.*')  ? 'active' : '' }}">Seminar</a>
    ...
    <div id="mobile-menu" class="mobile-menu md:hidden flex-col gap-1 pt-3 mt-3 border-t"
      ...
      <a href="{{ route('explore.index') }}" class="nav-link {{ request()->routeIs('explore.*') ? 'active' : '' }} px-2 py-2.5 block">Eksplorasi</a>
